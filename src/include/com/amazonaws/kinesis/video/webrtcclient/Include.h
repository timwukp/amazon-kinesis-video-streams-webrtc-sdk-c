...
/**
 * @brief Defines different states an RTC Peer connection traverses
 */
typedef enum {
...
typedef enum {
    ...
    SIGNALING_CLIENT_STATE_GET_CREDENTIALS,  //!< This state is set when signaling is in the get token state
    SIGNALING_CLIENT_STATE_DESCRIBE,         //!< This state is set when signaling is in the describe state
    SIGNALING_CLIENT_STATE_CREATE,           //!< This state is set after credentials are obtained
    SIGNALING_CLIENT_STATE_GET_ENDPOINT,     //!< This state is set to get end point after creation
    SIGNALING_CLIENT_STATE_GET_ICE_CONFIG,   //!< This state is set to get ICE config
    SIGNALING_CLIENT_STATE_READY,            //!< This state is set when signaling client is ready
    SIGNALING_CLIENT_STATE_CONNECTING,       //!< This state is set to indicate ongoing attempts to connect
    SIGNALING_CLIENT_STATE_CONNECTED,        //!< This state is set to indicate once connected
    SIGNALING_CLIENT_STATE_DISCONNECTED,     //!< This state is set to indicate disconnected state
